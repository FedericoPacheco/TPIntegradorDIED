...
public class FlujoMaximo extends JPanel 
{
	...
	private Object[][] recuperarDatos()
	{
		...
		for (i = 0; i < caminosYFlujosMaximos.size(); i++)
		{
			...
			datos[i][1] = caminosYFlujosMaximos.get(i).segundo.equals(RedDeTransporte.INFINITO_POSITIVO)? 
							"Infinito" : caminosYFlujosMaximos.get(i).segundo; 
			
			flujoTotal += caminosYFlujosMaximos.get(i).segundo;
		}	
		datos[i][0] = "Total";
		datos[i][1] = flujoTotal == RedDeTransporte.INFINITO_POSITIVO? "Infinito" : flujoTotal;
